...
//     vector<int> pxs; // x coordinates of pseudo pins
//     vector<int> pys; // y coordinates of pseudo pins
...
//         const int v = direction == 0 ? u + 1 : u + xs.size();
...
//     if (numDetached != 0) {
//         cout << "Error: failed to connect all pins." << endl;
//     }
// }
...
//             unsigned direction = (node->y == child->y ? 0 : 1);
...
//             if (node->x == child->x && node->y == child->y) {
//                 cout << "Error: duplicate tree nodes encountered." << endl;
//             }
//         }
//     });
//     return tree;
